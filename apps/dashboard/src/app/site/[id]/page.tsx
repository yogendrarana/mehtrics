      ...
      <main className="max-w-6xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            <h2 className="font-semibold text-sm uppercase tracking-wider text-muted-foreground">Top Pages</h2>
          ...
          {/* Top Referrers */}
          <div className="space-y-3">
            <h2 className="font-semibold text-sm uppercase tracking-wider text-muted-foreground">Top Referrers</h2>
            <div className="border border-border rounded-xl overflow-hidden">
              {stats.topReferrers.length === 0 ? (
                <p className="p-4 text-sm text-muted-foreground">No referrer data yet.</p>
              ) : (
                <table className="w-full text-sm">
                  <thead className="bg-muted/50 border-b border-border">
                    <tr>
        ...
        {/* Tracking Snippet */}
        <div className="space-y-3">
          <h2 className="font-semibold text-sm uppercase tracking-wider text-muted-foreground">Tracking Snippet</h2>
